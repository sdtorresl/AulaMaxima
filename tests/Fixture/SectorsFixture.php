...
class SectorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'picture_dir' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_sectors_business_idx' => ['type' => 'index', 'columns' => ['business_id'], 'length' => []],
        ],
        '_constraints' => [
